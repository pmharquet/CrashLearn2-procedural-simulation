...
# ---------------------------------------------------------------------------
def test_t05_vehicle_collision_no_terminate_knockback():
    """
...
# ---------------------------------------------------------------------------
def test_t10_dnf_no_corruption():
    """
    ...
    info = get_step_info()
    # Car 1 should be DNF
    assert info["agent_status"][1] == 0, (
        f"car 1 should be DNF, got status={info['agent_status'][1]}"
    )
    assert not info["opponents_mask"][1]
...
# ---------------------------------------------------------------------------
def test_t23_friction_initial_value():
